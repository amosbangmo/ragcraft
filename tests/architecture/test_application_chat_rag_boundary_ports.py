...
@pytest.mark.parametrize(
    ...
    [
        (
            Path("src") / "application" / "use_cases" / "chat" / "ask_question.py",
            ("RetrievalPort", "GenerationPort", "QueryLogPort"),
        ),
        (
            Path("src") / "application" / "use_cases" / "chat" / "inspect_rag_pipeline.py",
            ("RetrievalPort",),
        ),
        (
            Path("src") / "application" / "use_cases" / "chat" / "generate_answer_from_pipeline.py",
            ("GenerationPort",),
        ),
    ],
)
