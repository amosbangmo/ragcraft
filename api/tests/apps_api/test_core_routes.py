...
:class:`~infrastructure.config.exceptions.RAGCraftError` mapping, and :class:`ValueError` / :class:`FileNotFoundError`.
"""
...
class _FakeProjectService:
    """Minimal stand-in for :class:`~infrastructure.persistence.project_service.ProjectService`."""
...
class _FakeResolveProjectUseCase:
    """Mirrors :class:`~application.use_cases.projects.resolve_project.ResolveProjectUseCase` for tests."""
