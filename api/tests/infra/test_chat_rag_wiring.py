...
if "infrastructure.config.config" not in sys.modules:
    sys.modules["infrastructure.config.config"] = types.ModuleType("infrastructure.config.config")

config_module = sys.modules["infrastructure.config.config"]
...
if "infrastructure.rag.vectorstores.faiss.vector_store" not in sys.modules:
    faiss_store_module = types.ModuleType("infrastructure.rag.vectorstores.faiss.vector_store")
