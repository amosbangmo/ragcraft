...
vector recall → optional lexical recall → RRF merge → :class:`~domain.pipeline_payloads.SummaryRecallResult`.
"""
...
class ApplicationSummaryRecallStage:
    """
    Implements :class:`~application.use_cases.chat.orchestration.ports.SummaryRecallStagePort`.
