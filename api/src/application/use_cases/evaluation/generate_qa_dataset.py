...
class GenerateQaDatasetUseCase:
    ...
    LLM prompts and parsing live in :class:`~infrastructure.rag.llm.qa_dataset_llm_gateway.QADatasetLlmGateway`
    via :class:`~domain.common.ports.qa_dataset_generation_port.QaDatasetGenerationPort`.
    """
    ...
    def __init__(
        ...
        *,
        ...
        qa_dataset_generation_service: QaDatasetGenerationPort,
    ) -> None:
        self._qa = qa_dataset
