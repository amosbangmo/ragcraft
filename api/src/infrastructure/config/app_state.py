"""
Streamlit session singleton for the HTTP :class:`~services.backend.http_backend_client.HttpBackendClient`.

Pages obtain the client via :mod:`services.api_client` / :mod:`services.backend.backend_session`.
"""
