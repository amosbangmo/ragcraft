"""
SQLite adapter for query observability rows.

Implements :class:`domain.common.shared.query_log_port.QueryLogPersistencePort`.
"""
...
class SQLiteQueryLogRepositoryAdapter:
...
SQLiteQueryLogRepository = SQLiteQueryLogRepositoryAdapter
