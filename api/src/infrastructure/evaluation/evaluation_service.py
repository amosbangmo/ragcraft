...
class EvaluationService:
    """
    Evaluation façade: gold-QA runs via injected :class:`~domain.common.ports.gold_qa_benchmark_port.GoldQaBenchmarkPort`
    (wired in :mod:`composition.evaluation_wiring`), manual-eval assembly, and shared metric helpers.
    """
