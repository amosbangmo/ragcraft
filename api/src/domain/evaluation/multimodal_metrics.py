...
aligned with :class:`~domain.retrieved_asset.RetrievedAsset` and RAG pipeline payloads.
...
def analyze_prompt_asset_modalities(assets: list[Any]) -> dict[str, Any]:
    """Aligned with :class:`~application.chat.multimodal_prompt_hints.MultimodalPromptHints.analyze_modalities`."""
    has_text = False
    has_table = False
    has_image = False
