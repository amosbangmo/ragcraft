"""
SQLite-backed gold QA dataset rows.

Implements :class:`src.domain.evaluation.qa_dataset_repository_port.QADatasetRepositoryPort`.
"""
...
class SQLiteQADatasetRepository:
    def create_entry(
        self,
        *,
        user_id: str,
...
QADatasetRepository = SQLiteQADatasetRepository
