"""Thin technical adapters for :mod:`src.application.use_cases.chat.orchestration.summary_recall_workflow`."""
...
class QueryRewriteAdapter:
    """LLM-backed query rewrite (implements :class:`~src.application.use_cases.chat.orchestration.summary_recall_ports.QueryRewritePort`)."""
