...
from src.application.auth.dtos import ChangeUserPasswordCommand, ChangeUserPasswordResult
from src.core.exceptions import AuthCredentialsInvalidError, AuthValidationError, UserAccountNotFoundError
...
class ChangeUserPasswordUseCase:
    ...
    def execute(self, command: ChangeUserPasswordCommand) -> ChangeUserPasswordResult:
        ...
        self._users.update_password(command.user_id, self._password_hasher.hash_password(command.new_password))
