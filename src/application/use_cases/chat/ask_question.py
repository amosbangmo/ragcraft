...
class AskQuestionUseCase:
    """
    End-to-end RAG ask: build pipeline via :class:`~src.domain.ports.RetrievalPort`,
    generate answer via :class:`~src.domain.ports.GenerationPort`, merge latency,
    emit deferred query log via :class:`~src.domain.ports.QueryLogPort`,
    return :class:`~src.domain.rag_response.RAGResponse`.
    """
