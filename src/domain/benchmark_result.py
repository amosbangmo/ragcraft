...
class BenchmarkResult:
    ...
    Optional ``correlations`` holds Pearson summaries from :class:`~src.infrastructure.services.correlation_service.CorrelationService`.
    ...
    Optional ``auto_debug`` holds system-level suggestion cards from :class:`~src.infrastructure.services.auto_debug_service.AutoDebugService`.
