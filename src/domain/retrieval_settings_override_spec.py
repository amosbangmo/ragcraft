...
:class:`~src.domain.retrieval_settings.RetrievalSettings` (same allowlist as
:class:`~src.application.settings.retrieval_settings_tuner.RetrievalSettingsTuner.merge`).
"""
...
class RetrievalSettingsOverrideSpec:
    """Immutable overrides merged onto project/effective :class:`~src.domain.retrieval_settings.RetrievalSettings`."""
