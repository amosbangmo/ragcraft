...
class QueryLogIngressPayload:
    """
    Typed payload for query logging after a RAG pipeline run.

    Normalized to persistence rows in :class:`~src.infrastructure.adapters.query_logging.query_log_service.QueryLogService`.
    Built by application helpers (e.g. ``build_query_log_ingress_payload``).
    """
