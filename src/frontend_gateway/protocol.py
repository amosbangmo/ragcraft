"""
Stable surface for Streamlit (and future Angular) to call backend capabilities.

Implementations may be in-process (delegating to :class:`~src.app.ragcraft_app.RAGCraftApp`)
or remote (HTTP). Pages should depend only on this protocol, not on the façade or container.
"""
